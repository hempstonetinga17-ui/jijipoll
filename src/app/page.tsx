    ...
    <main className="relative w-full h-screen overflow-hidden bg-[#f06135]">
      ...
      <header className="absolute top-0 left-0 w-full z-20 p-6 flex justify-between items-center">
        ...
        <div className="space-x-4">
          <Link href="/login" className="text-white font-semibold hover:text-gray-200 transition drop-shadow-md">
            Log In
          </Link>
      ...
      <div className="absolute bottom-10 right-10 z-20 flex gap-4 sm:gap-6 scale-90 sm:scale-100 origin-bottom-right">
        <StatWidget value="120+" label="Countries" bgColor="bg-[#d35400]" />
        <StatWidget value="73" label="Languages" bgColor="bg-[#a8e6cf]" />
        <StatWidget value="10K+" label="Interviewers" bgColor="bg-[#bdc3c7]" />
      </div>
    </main>
  )
}
